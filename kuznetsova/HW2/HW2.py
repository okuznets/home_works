...
student1a_avg = sum(student1a_marks) / len(student1a_marks)
student2a_marks = list(sample_dict['class_a']['student2']['marks'].values())
student2a_avg = sum(student2a_marks) / len(student2a_marks)
student1b_marks = list(sample_dict['class_b']['student1']['marks'].values())
student1b_avg = sum(student1b_marks) / len(student1b_marks)
student2b_marks = list(sample_dict['class_b']['student2']['marks'].values())
student2b_avg = sum(student2b_marks) / len(student2b_marks)
...
class_a_avg = round((student1a_avg + student2a_avg) /2,2)
class_b_avg = round((student1b_avg + student2b_avg) /2,2)
